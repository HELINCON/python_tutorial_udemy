...
f = open(os.getenv("REQUEST_BODY_PATH", "request_raw_body_text.txt"), "r")
...
def create_authorisation_header(request_body=request_body_raw_text, created=None, expires=None):
    ...
    subscriber_id = os.getenv("SUBSCRIBER_ID", "bookmyecommerce.com")
    unique_key_id = os.getenv("UNIQUE_KEY_ID", "7b513900-60fd-4670-ba34-3dcd6481ecff")
...
def encrypt(crypto_private_key, crypto_public_key, null):
    ...
    text = b'ONDC is a Great Initiative!!From Iserveu'
...
# Signing_private_key: Gx65uxOWR/spii1EAvTgQNcqyTia2xE1Jq5gUs31TKfdU4kpmEstXTt9pK2QGvLMY7r9gNZWSlrtPJp25NcHAQ==
# Signing_public_key:  3VOJKZhLLV07faStkBryzGO6/YDWVkpa7TyaduTXBwE=
# Crypto_Privatekey:   MC4CAQAwBQYDK2VuBCIEIEDcWdjQ2iLwm/PllY9wDuI5YJtGhzxtL69wZdjdewBO
# Crypto_Publickey:    MCowBQYDK2VuAyEAvk7hY7vjLhcv4doCwH1AyrZs9WaWhm2mGIwLMoChmRc=